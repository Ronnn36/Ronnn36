...
def banner():
	print("""\x1b[0;91m 
\x1b[0;91m             ¯\_( ͡° ͜ʖ ͡°)_/¯
\x1b[0;91m
\x1b[0;97m    Roni ni bosss
\x1b[0;97m
...
def masuk():
    ...
    if __Kontol__Jimin__Buriq__ in(""):
    	print("%s[•] isi yang benar monyett"%(M));exit()
...
class ngentod:
    ...
    def mantan(self):
        ...
        if aangxd in ('01','1','M', 'm'):
            ...
            while True:
                ...
                if pwx == '':
                    ...
                    def zona(zafi_=None): 
                        ind = raw_input('\n%s[?] Metode : %s'%(P,K))
                        if ind == '':
                            print("%s[•] isi yang benar monyett "%(M));self.zona()
                        elif ind in ('1', '01'):
                            ...
                            print ('\n %s[•] isi yang benar monyett'%(M));zona()
            ...
            print("%s[•] isi yang benar monyett"%(M));jeda(2);menu()
    def langsung(self):
        __Aang__Sayang__Laura__ = raw_input('\n%s[%s?%s] Metode :%s '%(P,K,P,H))
        if __Aang__Sayang__Laura__ == '':
            print("%s[•] isi yang benar monyett"%(M));self.langsung()
            ...
            print("\n%s[•] isi yang benar monyett"%(M));self.langsung()
...
def uas():
    __Aang__Sayang__Laura__ = raw_input('\n%s[•] Pilih :%s '%(P,K))
    if __Aang__Sayang__Laura__ == '':
        print("%s[•] isi yang benar monyett"%(M));jeda(2);uas()
    elif __Aang__Sayang__Laura__ in("1","01"):
...
def menu():
    ...
    if __Aang__Sayang__Laura__ == '':
        ...
        print("%s[•] isi yang benar monyett"%(K));jeda(2);menu()
def hasill(__Aang__Sayang__Laura__):
	if __Aang__Sayang__Laura__ in[""]:
		print ("%s[%s•%s] isi yang benar monyett"%(P,P,K));exit()
	elif __Aang__Sayang__Laura__ in["1","01"]:
		try:
